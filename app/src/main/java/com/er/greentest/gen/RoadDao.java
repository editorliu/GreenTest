...
public class RoadDao extends AbstractDao<Road, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Road entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Road entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Road entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Road entity) {
