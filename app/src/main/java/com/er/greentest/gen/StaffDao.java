...
public class StaffDao extends AbstractDao<Staff, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CompanyId = new Property(4, long.class, "companyId", false, "COMPANY_ID");
    }

    private DaoSession daoSession;

    private Query<Staff> company_StaffsQuery;
    ...
    public Staff readEntity(Cursor cursor, int offset) {
        Staff entity = new Staff( //
            ...
            cursor.getLong(offset + 4) // companyId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Staff entity, int offset) {
        ...
        entity.setCompanyId(cursor.getLong(offset + 4));
     }
    ...
    /** Internal query to resolve the "staffs" to-many relationship of Company. */
    public List<Staff> _queryCompany_Staffs(long companyId) {
        synchronized (this) {
            if (company_StaffsQuery == null) {
                QueryBuilder<Staff> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.CompanyId.eq(null));
                company_StaffsQuery = queryBuilder.build();
            }
        }
        Query<Staff> query = company_StaffsQuery.forCurrentThread();
