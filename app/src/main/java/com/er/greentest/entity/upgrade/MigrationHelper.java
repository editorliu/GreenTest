...
//                    createTableStringBuilder.append(divider).append("\"").append(columnName).append("\"").append(" ").append(type);
            ...
            Log.w("greenDAO", "---------createTableStringBuilder:" + createTableStringBuilder.toString());
            ...
            //insert into tempTable (_id,name,price) select (_id,name,price) from table;
        }
    }
